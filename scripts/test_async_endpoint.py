...
def test_endpoint_async(endpoint_id, api_key, input_data, callback_url):
    ...
    try:
        ...
        try:
            ...
            print("Check the service where you created your callback URL to see the results.")
...
def main():
    ...
    """
    parser = argparse.ArgumentParser(description="Test the RunPod serverless endpoint with callbacks")
    ...
    parser.add_argument("--callback-url", help="The URL to receive results (use webhook.site or similar for testing)")
    parser.add_argument("--text", help="Text input for the model (or set DEFAULT_TEST_TEXT env var)")
    ...
    callback_url = args.callback_url or os.environ.get("RUNPOD_CALLBACK_URL", DEFAULT_CALLBACK_URL)
    ...
    if callback_url == DEFAULT_CALLBACK_URL:
        ...
        print("and specify it with --callback-url or set RUNPOD_CALLBACK_URL environment variable.")
